	...
	public override void OnEnter()
	{
		...
		if(finishedEvent != null)
		{
			if(!clip.IsNone && clip.Value != null)
				SoundManager.PlayImmediately(clip.Value as AudioClip, guaranteedLoop, SongEnd);
			else if(!clipObj.IsNone && clipObj.Value != null)
				SoundManager.PlayImmediately(clipObj.Value as AudioClip, guaranteedLoop, SongEnd);
		}
		else
		{
			if(!clip.IsNone && clip.Value != null)
				SoundManager.PlayImmediately(clip.Value as AudioClip, guaranteedLoop);
			else if(!clipObj.IsNone && clipObj.Value != null)
				SoundManager.PlayImmediately(clipObj.Value as AudioClip, guaranteedLoop);
